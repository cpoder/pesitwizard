...
public enum ClientState {
    ...
    static {
        ...
        CN03_CONNECTED.next =
                Set.of(SF01A_CREATE_PENDING, SF02A_SELECT_PENDING, CN04A_RELEASE_PENDING, ERROR);
        ...
        OF02_TRANSFER_READY.next =
                Set.of(TDE01A_WRITE_PENDING, TDL01A_READ_PENDING, OF03A_CLOSE_PENDING, ERROR);
        ...
        TDE02A_SENDING_DATA.next =
                Set.of(TDE02A_SENDING_DATA, TDE03_SYNC_PENDING, TDE07_DATA_END, ERROR);
        ...
        TDL02A_RECEIVING_DATA.next =
                Set.of(TDL02A_RECEIVING_DATA, TDL03_SYNC_ACK, TDL07_DATA_END, ERROR);
    ...
    public Set<ClientState> getValidNext() {
        return next;
    }

    public boolean canTransitionTo(ClientState n) {
        return next != null && next.contains(n);
    }

    public boolean canSendData() {
        return this == TDE02A_SENDING_DATA;
    }

    public boolean canReceiveData() {
        return this == TDL02A_RECEIVING_DATA;
    }

    public boolean isConnected() {
        return this != CN01_REPOS && this != ERROR;
    }
}
