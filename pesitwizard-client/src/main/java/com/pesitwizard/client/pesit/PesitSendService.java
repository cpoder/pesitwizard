    ...
    public void sendFile(
        ...
        try {
            if (request.getSourceConnectionId() != null) {
                ...
                // toRealPath() resolves symlinks, canonicalizes, and verifies existence
                Path realPath = Path.of(request.getFilename()).toRealPath();
                inputStream = new BufferedInputStream(Files.newInputStream(realPath), 64 * 1024);
            }
