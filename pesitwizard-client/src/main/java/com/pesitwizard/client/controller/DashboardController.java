...
/** Dashboard controller providing comprehensive overview of the PeSIT client status. */
@RestController
    ...
    public ResponseEntity<Map<String, Object>> getDashboard() {
        ...
        dashboard.put(
                ...
                Map.of(
                        ...
                        "inProgress",
                        stats.inProgressTransfers(),
                        "bytesTransferred",
                        stats.totalBytesTransferred() != null
                                ? stats.totalBytesTransferred()
                                : 0L));

        // In-progress transfers
        List<TransferHistory> inProgress =
                transferHistoryRepository.findByStatus(TransferHistory.TransferStatus.IN_PROGRESS);
        dashboard.put(
                "activeTransfers",
                inProgress.stream()
                        .map(
                                        ...
                                        Map.of(
                                                ...
                                                "serverName",
                                                        t.getServerName() != null
                                                                ...
                                                                : "Unknown",
                                                "progress",
                                                        t.getBytesTransferred() != null
                                                                ? t.getBytesTransferred()
                                                                : 0,
                                                "startedAt",
                                                        t.getStartedAt() != null
                                                                ? t.getStartedAt().toString()
                                                                : null))
                        .toList());
                                ...
                                .map(
                                        s ->
                                                Map.of(
                                                        ...
                                                        "port", s.getPort(),
                                                        "enabled", s.isEnabled(),
                                                        "defaultServer", s.isDefaultServer()))
                                .toList()));
        ...
        dashboard.put(
                "security",
                Map.of(
                        "encryptionEnabled", securityStatus.available(),
                        "encryptionMode", securityStatus.providerType(),
