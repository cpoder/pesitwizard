...
class PathPlaceholderServiceTest {
    ...
    class ResolvePathTests {
        ...
        void shouldResolvePartnerPlaceholder() {
            PlaceholderContext ctx = PlaceholderContext.builder().partnerId("CLIENT001").build();
        ...
        void shouldResolvePartnerIdPlaceholder() {
            PlaceholderContext ctx = PlaceholderContext.builder().partnerId("PARTNER123").build();
        ...
        void shouldResolveVirtualFilePlaceholder() {
            PlaceholderContext ctx = PlaceholderContext.builder().virtualFile("VFILE01").build();
        ...
        void shouldResolveServerPlaceholder() {
            PlaceholderContext ctx = PlaceholderContext.builder().serverId("SRV001").build();
        ...
        void shouldResolveServerNamePlaceholder() {
            PlaceholderContext ctx = PlaceholderContext.builder().serverName("Production").build();
        ...
        void shouldResolveDirectionPlaceholder() {
            PlaceholderContext ctx = PlaceholderContext.builder().direction("SEND").build();
        ...
        void shouldResolveTimestampPlaceholder() {
            String result =
                    service.resolvePath(
                            "/data/file_${timestamp}.dat", PlaceholderContext.builder().build());
        ...
        void shouldResolveDatePlaceholder() {
            String result =
                    service.resolvePath(
                            "/data/${date}/files", PlaceholderContext.builder().build());
        ...
        void shouldResolveTimePlaceholder() {
            String result =
                    service.resolvePath(
                            "/data/file_${time}.dat", PlaceholderContext.builder().build());
        ...
        void shouldResolveYearPlaceholder() {
            String result =
                    service.resolvePath(
                            "/data/${year}/archive", PlaceholderContext.builder().build());
        ...
        void shouldResolveMonthPlaceholder() {
            String result =
                    service.resolvePath(
                            "/data/${month}/files", PlaceholderContext.builder().build());
        ...
        void shouldResolveDayPlaceholder() {
            String result =
                    service.resolvePath("/data/${day}/files", PlaceholderContext.builder().build());
        ...
        void shouldResolveHourPlaceholder() {
            String result =
                    service.resolvePath(
                            "/data/${hour}/files", PlaceholderContext.builder().build());
        ...
        void shouldResolveMinutePlaceholder() {
            String result =
                    service.resolvePath(
                            "/data/${minute}/files", PlaceholderContext.builder().build());
        ...
        void shouldResolveSecondPlaceholder() {
            String result =
                    service.resolvePath(
                            "/data/${second}/files", PlaceholderContext.builder().build());
        ...
        void shouldResolveUuidPlaceholder() {
            String result =
                    service.resolvePath("/data/${uuid}.dat", PlaceholderContext.builder().build());
        ...
        void shouldResolveMultiplePlaceholders() {
            ...
            String result =
                    service.resolvePath("/data/${partner}/${server}/${direction}/files", ctx);
        ...
        void shouldKeepUnresolvedPlaceholders() {
            String result =
                    service.resolvePath(
                            "/data/${unknown}/files", PlaceholderContext.builder().build());
        ...
        void shouldHandleSpecialRegexCharacters() {
            PlaceholderContext ctx = PlaceholderContext.builder().partnerId("CLIENT$01").build();
