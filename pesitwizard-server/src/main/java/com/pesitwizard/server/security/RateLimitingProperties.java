...
public class RateLimitingProperties {
    ...
    /**
     * Burst multiplier - allows temporary spikes above sustained rate. E.g., 2x means 200 requests
     * can be made in a burst before limiting.
     */
    ...
    /**
     * Enable Redis-based distributed rate limiting. When false, uses in-memory buckets (not
     * cluster-aware).
     */
