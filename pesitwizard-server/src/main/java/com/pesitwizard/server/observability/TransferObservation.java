...
/**
 * Observation helper for creating traced transfer operations. Integrates with OpenTelemetry for
 * distributed tracing.
 */
@Slf4j
@Component
...
public class TransferObservation {
    ...
    public Observation createTransferObservation(
            String transferId, String partnerId, String filename, String direction) {
    ...
    public void recordTransferStart(String transferId, String partnerId, String direction) {
        ...
        log.debug(
                "Transfer started: id={}, partner={}, direction={}",
                transferId,
                partnerId,
                direction);
    }
    ...
    public void recordTransferComplete(
            String transferId, String partnerId, String direction, long bytes, long durationMs) {
        metrics.transferCompleted(partnerId, direction, bytes, durationMs);
        log.debug(
                "Transfer completed: id={}, partner={}, bytes={}, duration={}ms",
                transferId,
                partnerId,
                bytes,
                durationMs);
    ...
    public void recordTransferFailed(
        ...
        log.warn(
                "Transfer failed: id={}, partner={}, error={}: {}",
                transferId,
                partnerId,
                errorCode,
                errorMessage);
