...
public class SslProperties {
    ...
    /**
     * Base64-encoded keystore data (from environment variable PESIT_TLS_KEYSTORE_DATA). When
     * provided, this takes precedence over keystoreName.
     */
    ...
    /**
     * CA certificate in PEM format (from environment variable PESIT_TLS_CA_CERT_PEM). Used to build
     * a truststore for validating client certificates.
     */
    private String caCertPem;

    /**
     * Client authentication mode for mTLS. NONE = no client cert required WANT = request client
     * cert but don't require it NEED = require valid client certificate (mandatory mTLS)
     */
    ...
    /**
     * Allowed TLS protocol versions (applied to SSLServerSocket). Only TLSv1.2 and TLSv1.3 are
     * considered secure.
     */
