...
/**
 * Entity for storing file checksums for integrity verification. Supports SHA-256 and other hash
 * algorithms.
 */
@Entity
@Table(
...
public class FileChecksum {
    ...
    @Column private String transferId;

    /** Partner ID associated with the file */
    @Column private String partnerId;

    /** Server ID where the file was received/sent */
    @Column private String serverId;
    ...
    @Column private Instant computedAt;
    ...
    @Column @Builder.Default private Integer duplicateCount = 0;

    /** First time this checksum was seen */
    @Column private Instant firstSeenAt;
