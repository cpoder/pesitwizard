...
/**
 * Entity for storing keystores and truststores centrally in the database. Supports JKS, PKCS12, and
 * PEM formats.
 *
 * <p>This enables cluster-wide certificate management where all nodes share the same certificates
 * from the central database.
 */
@Entity
@Table(
        name = "certificate_stores",
        uniqueConstraints = @UniqueConstraint(columnNames = {"name", "storeType"}),
        indexes = {
...
public class CertificateStore {
    ...
    /**
     * The binary content of the keystore/truststore For PEM format, this contains the concatenated
     * certificates/keys
     */
    ...
    /**
     * Password for the store (encrypted) For PEM format with encrypted private keys, this is the
     * key password
     */
    @Column(length = 500)
