...
class CertificateControllerTest {
    ...
    @MockitoBean private CertificateAuthorityService caService;
    ...
    class ListAndGetTests {
        ...
        void shouldReturn404ForNonExistent() throws Exception {
            ...
            mockMvc.perform(get("/api/v1/certificates/999")).andExpect(status().isNotFound());
        }
    ...
    class ActionsTests {
        ...
        void shouldSetAsDefault() throws Exception {
            ...
            mockMvc.perform(post("/api/v1/certificates/1/set-default")).andExpect(status().isOk());
        }
        ...
        void shouldActivateCertificate() throws Exception {
            ...
            mockMvc.perform(post("/api/v1/certificates/1/activate")).andExpect(status().isOk());
        }
        ...
        void shouldDeactivateCertificate() throws Exception {
            ...
            mockMvc.perform(post("/api/v1/certificates/1/deactivate")).andExpect(status().isOk());
        }
    ...
    class DeleteTests {
        ...
        void shouldDeleteCertificate() throws Exception {
            ...
            mockMvc.perform(delete("/api/v1/certificates/1")).andExpect(status().isNoContent());
        }
        ...
        void shouldReturn404WhenDeletingNonExistent() throws Exception {
            doThrow(new IllegalArgumentException("Not found"))
                    .when(certificateService)
                    .deleteCertificateStore(999L);

            mockMvc.perform(delete("/api/v1/certificates/999")).andExpect(status().isNotFound());
        }
    }
    ...
    class ExpirationTests {
        ...
        void shouldGetExpiringCertificates() throws Exception {
            when(certificateService.getExpiringCertificates(30)).thenReturn(List.of(testKeystore));
    ...
    class CreateEmptyStoresTests {
        ...
        void shouldCreateEmptyKeystore() throws Exception {
            when(certificateService.createEmptyKeystore(
                            any(), any(), any(), any(), any(), any(), anyBoolean(), any()))
                    .thenReturn(testKeystore);

            mockMvc.perform(
                            post("/api/v1/certificates/keystores/create")
        ...
        void shouldCreateEmptyTruststore() throws Exception {
            when(certificateService.createEmptyTruststore(
                            any(), any(), any(), any(), any(), anyBoolean(), any()))
                    .thenReturn(testTruststore);

            mockMvc.perform(
                            post("/api/v1/certificates/truststores/create")
