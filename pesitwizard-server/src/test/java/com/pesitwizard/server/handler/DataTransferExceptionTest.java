...
class DataTransferExceptionTest {
    ...
    void shouldCreateWithDiagnosticCodeAndMessage() {
        DataTransferHandler.DataTransferException ex =
                new DataTransferHandler.DataTransferException(DiagnosticCode.D0_000, "Success");
    ...
    void shouldBeIOException() {
        DataTransferHandler.DataTransferException ex =
                new DataTransferHandler.DataTransferException(DiagnosticCode.D3_300, "Congestion");
    ...
    void shouldHandleDifferentDiagnosticCodes() {
        DataTransferHandler.DataTransferException ex1 =
                new DataTransferHandler.DataTransferException(DiagnosticCode.D3_301, "Unknown ID");
        DataTransferHandler.DataTransferException ex2 =
                new DataTransferHandler.DataTransferException(DiagnosticCode.D3_300, "Congestion");
