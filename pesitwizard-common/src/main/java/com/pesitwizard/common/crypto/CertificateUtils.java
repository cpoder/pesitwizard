...
public class CertificateUtils {
    ...
    /**
     * Build a signed certificate with standard X.509 extensions (BasicConstraints, KeyUsage, EKU,
     * SKI, AKI, SAN). This is the shared implementation used by both OSS and enterprise CA
     * services.
     *
    ...
    public static X509Certificate buildSignedCertificate(
        ...
        try {
            ...
            Date notBefore = new Date();
            Date notAfter =
                    new Date(System.currentTimeMillis() + validityDays * 24L * 60 * 60 * 1000);
            ...
            ContentSigner signer =
                    new JcaContentSignerBuilder(SIGNATURE_ALGORITHM).build(issuerKey);
