...
/**
 * Validation annotation for safe file paths. Rejects paths that contain traversal sequences or
 * unsafe characters.
 */
...
public @interface SafePath {
    ...
    /**
     * If true, allows paths with directory components. If false, only simple filenames are allowed.
     */
