...
/**
 * Builder for PESIT F.SELECT message Used to initiate a read (receive) file transfer - request an
 * existing file
 */
public class SelectMessageBuilder {
    ...
    public Fpdu build(int serverConnectionId) throws IOException {
        ...
        fpdu.withParameter(pi17).withParameter(pi25).withIdDst(serverConnectionId);
